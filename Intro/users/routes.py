...
from Intro import db, bcrypt
from Intro.models import User, Post
from Intro.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm
from Intro.users.utils import save_picture, send_reset_email
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password,form.password.data):
            ...
            if next_page:
                return redirect(next_page.strip('/'))
            return redirect(url_for('main.home'))
        else:
